...
const sendData = (body) => fetch('https://24.javascript.pages.academy/kekstagram',
  {
    method: 'POST',
    body,
  }).then((response) => {
...
// export {createDataRequest, sendData, showAlert, dataPostSuccess, dataPostError, showLoadImgMessage, removeLoadImgMessage};
// export {
//   dataArray
// };
